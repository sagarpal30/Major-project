<?php
    ...
    function sendMail($email,$reset_token)
    {
        ...
        try {
            ...
            $mail->Body    = "We got a request from you to reset your password<br>
             ...
             <a href='http://localhost/final project/updatepassword.php?email=$email&resettoken=$reset_token'>Reset Password</a>
             ";
    ...
    {
        $query = "SELECT * FROM asignup WHERE emailid = '$_POST[email]'";
        ...
        if($result)
        {
            if(mysqli_num_rows($result) == 1)
            {
                ...
                $date=date("y-m-d");
                $query = "UPDATE asignup SET resettoken='$reset_token', resettokenexpire='$date' WHERE emailid='$_POST[email]'";
